...
const ObituaryForm: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert('Umrlica je uspešno poslata na obradu!');
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 px-2 sm:px-4 py-4 sm:py-8">
      <div className="max-w-4xl mx-auto space-y-6 sm:space-y-8">
        <FormHeader title="UČITAJ UMRLICU" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
              ...
              <div className="md:col-span-2">
                ...
                <div className="border-2 border-dashed border-yellow-600/50 rounded-xl p-4 sm:p-6 md:p-8 text-center hover:border-yellow-500/70 transition-colors">
                  ...
                  <label htmlFor="image-upload" className="cursor-pointer">
                    <Upload className="mx-auto mb-3 sm:mb-4 text-yellow-500" size={36} />
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full px-3 sm:px-4 py-2 sm:py-3 bg-slate-700 border border-yellow-600/50 rounded-xl text-slate-100 focus:outline-none focus:ring-2 focus:ring-yellow-500 resize-none text-sm sm:text-base sm:rows-6"
                  placeholder="Unesite tekst umrlice..."
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange('graveLocation')}
                  className="w-full px-3 sm:px-4 py-2 sm:py-3 bg-slate-700 border border-yellow-600/50 rounded-xl text-slate-100 focus:outline-none focus:ring-2 focus:ring-yellow-500 text-sm sm:text-base"
                  placeholder="Adresa groblja"
                />
              </div>

              <div>
                <label className="block text-slate-200 text-base sm:text-lg font-medium mb-3 sm:mb-4">
                  Lokacija sale za parastos
                </label>
                <input
                  type="text"
                  value={formData.memorialLocation}
                  onChange={handleInputChange('memorialLocation')}
                  className="w-full px-3 sm:px-4 py-2 sm:py-3 bg-slate-700 border border-yellow-600/50 rounded-xl text-slate-100 focus:outline-none focus:ring-2 focus:ring-yellow-500 text-sm sm:text-base"
                  placeholder="Adresa sale za parastos"
                />
              </div>
              ...
              <div className="md:col-span-2">
                <label className="block text-slate-200 text-base sm:text-lg font-medium mb-3 sm:mb-4">
                  Učitavanje smrtovnice
                </label>
                <input
                  type="file"
                  accept=".pdf,.doc,.docx,.jpg,.jpeg,.png"
                  className="w-full px-3 sm:px-4 py-2 sm:py-3 bg-slate-700 border border-yellow-600/50 rounded-xl text-slate-100 focus:outline-none focus:ring-2 focus:ring-yellow-500 file:mr-2 sm:file:mr-4 file:py-1 sm:file:py-2 file:px-2 sm:file:px-4 file:rounded-lg file:border-0 file:text-xs sm:file:text-sm file:font-semibold file:bg-yellow-600 file:text-slate-900 hover:file:bg-yellow-500 text-sm sm:text-base"
                />
              </div>
            </div>
          </div>
